...
<ul>
    ...
    <li>Click on <i>Screen Options</i> and check the <i>Shortcodes</i> box<br>
        <img src="<?= GLF_PLUGIN_URL . 'assets/images/help/publishing/q2-1.png' ?>">
    </li>
    ...
    <li>
        ...
        <img src="<?= GLF_PLUGIN_URL . 'assets/images/help/publishing/q2-2.png' ?>"></li>
    <li>Depending on your theme, your navigation will look something like this:<br>
        <img src="<?= GLF_PLUGIN_URL . 'assets/images/help/publishing/q2-3.png' ?>">
    </li>
    <li>
        ...
        <div class="code"><?= Glf_Utils::glf_mor_get_shortcode( Glf_Utils::glf_get_restaurants()[ 0 ]->uid, 'ordering', true, "glf-btn-basic" ); ?></div>
        which will produce this result:<br>
        <img src="<?= GLF_PLUGIN_URL . 'assets/images/help/publishing/q2-4.png' ?>"><br>
        ...
        <ol>
            <li style="list-style-type: lower-alpha">
                ...
                <div class="code"><?= Glf_Utils::glf_mor_get_shortcode( Glf_Utils::glf_get_restaurants()[ 0 ]->uid, 'ordering', true ); ?></div>
                <img src="<?= GLF_PLUGIN_URL . 'assets/images/help/publishing/q2-5.png' ?>">
            </li>
            <li style="list-style-type: lower-alpha">
                Or just use a class of yours, like this:
                <div class="code"><?= Glf_Utils::glf_mor_get_shortcode( Glf_Utils::glf_get_restaurants()[ 0 ]->uid, 'ordering', true, "your_class_name" ); ?></div>
            </li>
        </ol>
    </li>
</ul>
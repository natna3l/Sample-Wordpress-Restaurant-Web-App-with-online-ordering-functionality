		...
		$repeater->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} {{CURRENT_ITEM}}.premium-pricing-list-item svg' => 'fill: {{VALUE}}',
				),
				'condition' => array(
					'icon_type' => 'icon',
				),
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .premium-pricing-icon-container svg'  => 'fill: {{VALUE}};',
				),
				'condition' => array(
					'icon_type' => 'icon',
				),
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .premium-pricing-list-item svg'  => 'fill: {{VALUE}}',
				),
			)
		);

		...
		$repeater_list->add_control(
			...
			array(
				...
				'selectors'  => array(
					...
					'{{WRAPPER}} {{CURRENT_ITEM}} .premium-icon-list-wrapper svg, {{WRAPPER}} {{CURRENT_ITEM}} .premium-icon-list-wrapper img' => 'width: {{SIZE}}{{UNIT}} !important; height: {{SIZE}}{{UNIT}} !important;',
				),
				'condition'  => array(
		...
		$repeater_list->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} {{CURRENT_ITEM}} .premium-icon-list-wrapper svg' => 'fill: {{VALUE}}',
					'{{WRAPPER}} .premium-icon-list-blur:hover {{CURRENT_ITEM}} .premium-icon-list-wrapper i, {{WRAPPER}} .premium-icon-list-blur:hover {{CURRENT_ITEM}} .premium-icon-list-wrapper svg' => 'text-shadow: 0 0 3px {{VALUE}}',
				),
				'condition' => array(
					'show_icon'         => 'yes',
					'icon_type'         => 'icon',
		...
		$repeater_list->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}}  {{CURRENT_ITEM}}.premium-icon-list-content:hover .premium-icon-list-wrapper svg' => 'fill: {{VALUE}}',
					'{{WRAPPER}} .premium-icon-list-blur {{CURRENT_ITEM}}.premium-icon-list-content:hover .premium-icon-list-wrapper i, {{WRAPPER}} .premium-icon-list-blur {{CURRENT_ITEM}}.premium-icon-list-content:hover .premium-icon-list-wrapper svg' => 'text-shadow: none !important; color: {{VALUE}} !important',
				),
				'condition' => array(
					'show_icon'         => 'yes',
					'icon_type'         => 'icon',
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					...
					'{{WRAPPER}}  .premium-icon-list-wrapper svg , {{WRAPPER}}  .premium-icon-list-wrapper img'    => 'width: {{SIZE}}{{UNIT}} !important; height: {{SIZE}}{{UNIT}} !important',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .premium-icon-list-wrapper svg' => 'fill: {{VALUE}}',
					'{{WRAPPER}} .premium-icon-list-blur:hover .premium-icon-list-wrapper i, {{WRAPPER}} .premium-icon-list-blur:hover .premium-icon-list-wrapper svg, {{WRAPPER}} .premium-icon-list-blur:hover .premium-icon-list-wrapper .premium-icon-list-icon-text p' => 'text-shadow: 0 0 3px {{VALUE}};',
				),
			)
		);
